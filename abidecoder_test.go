...
func TestABI_Read(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "symbol", typeName: "symbol", data: EOSCCSymbol, expectedValue: s(`"4,EOSCC"`)},
		{name: "symbol_code", typeName: "symbol_code", data: SymbolCode(22606239386324546), expectedValue: s(`"BNTDAPP"`)},
		{name: "asset", typeName: "asset", data: Asset{Amount: 100000, Symbol: EOSCCSymbol}, expectedValue: s(`"10.0000 EOSCC"`)},
		{name: "extended_asset", typeName: "extended_asset", data: ExtendedAsset{Asset: Asset{Amount: 10, Symbol: EOSCCSymbol}, Contract: "zhongshuwen1"}, expectedValue: s("{\"quantity\":\"0.0010 EOS\",\"contract\":\"zhongshuwen1\"}")},
...
func TestABI_Read_Symbol(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, `"4,EOSCC"`, toJSON(t, out))
}
